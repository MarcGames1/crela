...
const MainHeader = ({ title, paragraph, image }: IMainHeader) => (
  <section className="p-10 max-w-full relative overflow-hidden pt-10 pb-2 md:py-24">
    <div className="absolute bottom-[0px] left-0 h-full w-[200%]  overflow-x-hidden origin-bottom-left -translate-y-4/12 -rotate-12 transform bg-gradient-to-t from-[#800507] to-[#DA2128] md:translate-y-0"></div>
