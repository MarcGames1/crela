...
export const PostWrapper = ({ value, widget, children }) => {
    ...
    <>
      <BlogPostContext.Provider value={value}>
        ...
        >
          ...
          <h1
            className={tw('m-2 absolute text-center lg:text-4xl text-4xl z-2')}
          >
            {title}
          </h1>
        </div>
        <>
          <div className={tw(' md:grid md:grid-cols-12 gap-3	')}>
            ...
            <aside
              className={tw(
                'flex flex-col justify-top m-4 border-3 items-center container md:col-span-3'
              )}
            >
              <div
                className={
                  widget
                    ? tw(' lg:right-0 lg:top-15 ')
                    : tw('lg:sticky lg:right-0 lg:top-15 ')
                }
              >
